...
class ProgrammeController extends Controller
{
    ...
    {
        //
        return view('/Sectoriel/Programmes/index');
    }
    ...
    {
        return view('/Sectoriel/Programmes/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('sectoriel.programmes.show',$item->token));
    ...
    public function show(string $token)
    {
        ...
        return view('Sectoriel/Programmes/show',compact('item','banques','organismes','indicateurs'));
    }
    ...
    public function saveComposante(Request $request)
    {
        ...
        Session::flash('success','Enregistrement effectué avec succès!');
        return redirect(route('sectoriel.programmes.show',$token));
    }
