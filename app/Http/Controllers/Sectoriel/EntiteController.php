...
class EntiteController extends ExtendedController
{
    ...
    {
        //
        return view('Sectoriel/Entites/index');
    }
    ...
    public function create()
    {
        ...
        return view('Sectoriel/Entites/create');
    }
    ...
    public function createFromMember($token)
    {
        ...
        return view('Sectoriel/Entites/create_from_member',compact('item'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //dd($data);
        return redirect(route('sectoriel.entites.index'));
    }
    ...
    public function show(string $token)
    {
        ...
        return view('/Sectoriel/Entites/show',compact('item','mr','programmes','analystes','appuis','elements'));
    ...
    public function createTiersPhysique(string $token)
    {
        ...
        return view('/Sectoriel/Entites/tiers_physique',compact('item'));
    }
    ...
    public function createTiersMorale(string $token)
    {
        ...
        $formes = Forme::all();
        return view('/Sectoriel/Entites/tiers_morale',compact('item','formes'));
    }
    ...
    public function saveTiersPhysique(Request $request)
    {
        ...
        Session::flash('success','Enregistrement effectué avec succès!');
        return redirect(route('sectoriel.entites.show',$token));
    }
    ...
    public function createQuestionnaire(string $token)
    {
        ...
        return view('/Sectoriel/Entites/questionnaire',compact('item','criteres'));
    }
    ...
    public function edit(string $token)
    {
        ...
        if($item){
            $formes = Forme::all();
            return view('Sectoriel.Entites.edit',compact('item','formes'));
        }
        return back();
    }
