...
class CompanyController extends ExtendedController
{
    ...
    {
        //
        return view('/Sectoriel/Companies/index');
    }

    public function getProspects()
    {
        //
        return view('/Sectoriel/Companies/prospects');
    }
    ...
    public function create()
    {
        ...
        return view('/Sectoriel/Companies/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        //dd($data);
        return redirect(route('sectoriel.entreprises.index'));
    }
    ...
    public function getEngagementReport($token){
        ...
        if($entreprise){
            ...
            return view('Sectoriel.Companies.engagement_report',compact('engagements','entreprise','banques'));
        }else{
            return back();
        }
    ...
    public function show(string $token)
    {
        ...
        return view('/Sectoriel/Companies/show',compact('item','mr','programmes','analystes','appuis','elements'));
    ...
    public function saveProgramme(Request $request)
    {
        ...
        $data['sectoriel_id'] = auth()->user()->id;
        $data['agence_id'] = auth()->user()->agence_id;
        $data['representation_id'] = auth()->user()->representation_id;
    ...
    public function createTiersPhysique(string $token)
    {
        ...
        return view('/Sectoriel/Companies/tiers_physique',compact('item'));
    }
    ...
    public function createTiersMorale(string $token)
    {
        ...
        $formes = Forme::all();
        return view('/Sectoriel/Companies/tiers_morale',compact('item','formes'));
    }
    ...
    public function saveTiersPhysique(Request $request)
    {
        ...
        Session::flash('success','Enregistrement effectué avec succès!');
        return redirect(route('sectoriel.entreprises.show',$token));
    }
    ...
    public function createQuestionnaire(string $token)
    {
        ...
        return view('/Sectoriel/Companies/questionnaire',compact('item','criteres'));
    }
    ...
    public function edit(string $token)
    {
        ...
        if($item){
            $formes = Forme::all();
            return view('Sectoriel.Companies.edit',compact('item','formes'));
        }
        return back();
    }
