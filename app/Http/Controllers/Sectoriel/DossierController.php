...
class DossierController extends Controller
{
    ...
    {
        //
        return view('/Sectoriel/Dossiers/index');
    }

    public function fetchAll(){
        $items = Dossier::orderBy('created_at','DESC')->where('sectoriel_id',auth()->user()->id)->get();
    ...
    public function show($token){
        ...
        return view('Sectoriel/Dossiers/show',compact('item','indicateurs','criteres','sme','banques'));
    }
