...
class EntrepriseController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($items);
        return view('/Sectoriel/Entreprises/index')->with(compact('items'));
    }
    ...
    public function getDossier($id){
       ...
       // $nf = $dossier['note'];
        $sme = $resp['sme'];
        return view('/Sectoriel/Entreprises/dossier',compact('id','dossier','entreprise','engagements','indicateurs','criteres','sme','banques'));
    }
    ...
    public function _getDossier($id){
        ...
        return view('/Sectoriel/Instruction/dossier',compact('id','note3','criteres','notes','nf','sme'));
    }

    public function getCreateInstruction($id){
        return view('/Sectoriel/Instruction/create',compact('id'));
    }
	...
	public function show($id)
	{
        ...
        $engagements = $resp['engagements'];
        $banques = $resp['banques'];
        return view('/Sectoriel/Entreprises/show')->with(compact('item','engagements','banques'));
	}
