...
class EntrepriseController extends Controller
{
    ...
    public function getDossier($id)
    {
        ...
        return view('/Admin/Entreprises/dossier', compact('id', 'dossier', 'entreprise', 'engagements', 'indicateurs', 'criteres', 'sme', 'banques'));
    }
    ...
    {
        return view('/Admin/Instruction/create', compact('id'));
    }
