...
class InstructionController extends Controller
{
    ...
    public function getCritereParamsForm(){
        ...
        return view('/Admin/Instruction/params')->with(compact('items'));
    }
    ...
    public function loadDsf(){
       ...
       dd($ret->body());
        return redirect(route('admin.instruction.dossier',$dossier_id));
    }
    ...
    public function getDossier($id){
       ...
       // dd($note3);
        return view('/Admin/Instruction/dossier',compact('id','note3'));
    }
    ...
    public function findDossier(){
        ...
        $sme = $dossier['sme'];
       // dd($sme);
        return view('/Admin/Instruction/dossier',compact('id','note3','criteres','notes','nf','sme'));
    }
