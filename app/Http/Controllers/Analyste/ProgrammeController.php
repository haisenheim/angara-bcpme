...
class ProgrammeController extends Controller
{
    ...
    {
        //
        return view('/Analyste/Programmes/index');
    }
    ...
    public function fetchStats(Request $request)
    {
        ...
        $base = Programme::query();
        $query = $this->applyProgrammeFilters($base->clone(), $filters);
    ...
    {
        return view('/Analyste/Programmes/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('analyste.programmes.show', $item->token));
    ...
    public function show(string $token)
    {
        ...
        return view('Analyste/Programmes/show', compact('item', 'banques', 'organismes', 'indicateurs'));
    }
    ...
    public function saveComposante(Request $request)
    {
        ...
        return redirect(route('analyste.programmes.show', $token));
    }
