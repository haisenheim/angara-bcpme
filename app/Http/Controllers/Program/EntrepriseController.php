...
class EntrepriseController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($items);
        return view('/Program/Entreprises/index')->with(compact('items'));
    }
    ...
    public function getDossier($id){
       ...
       // $nf = $dossier['note'];
        $sme = $resp['sme'];
        return view('/Program/Entreprises/dossier',compact('id','dossier','entreprise','engagements','indicateurs','criteres','sme','banques'));
    }
    ...
    public function _getDossier($id){
        ...
        return view('/Program/Instruction/dossier',compact('id','note3','criteres','notes','nf','sme'));
    }

    public function getCreateInstruction($id){
        return view('/Program/Instruction/create',compact('id'));
    }
	...
	public function show($id)
	{
        ...
        $engagements = $resp['engagements'];
        $banques = $resp['banques'];
        return view('/Program/Entreprises/show')->with(compact('item','engagements','banques'));
	}
