...
class DossierController extends Controller
{
    ...
    {
        //
        return view('/Program/Dossiers/index');
    }

    public function fetchAll(){
        $items = Dossier::orderBy('created_at','DESC')->where('program_id',auth()->user()->id)->get();
    ...
    public function show($token){
        ...
        return view('/Program/dossiers/show',compact('item','dossier','entreprise','engagements','indicateurs','criteres','sme','banques'));
    }
}
