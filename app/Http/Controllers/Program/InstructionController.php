...
class InstructionController extends Controller
{
    ...
    public function index()
    {
        //
        $items = Libelle::all();
        return view('/Program/Libelles/index')->with(compact('items'));
    }
    ...
    public function getCritereParamsForm(){
        ...
        return view('/Program/Instruction/params')->with(compact('items'));
    }

    public function createDossier(){
        return view('/Program/Instruction/create');
    }
    ...
    public function getDossier($id){
       ...
       // dd($note3);
        return view('/Program/Instruction/dossier',compact('id','note3'));
    }
