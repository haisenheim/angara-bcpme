...
class CompanyController extends Controller
{
    ...
    {
        //
        return view('/Program/Companies/index');
    }

    public function getProspects()
    {
        //
        return view('/Program/Companies/prospects');
    }
    ...
    public function create()
    {
        //
        $formes = Forme::all();
        return view('/Program/Companies/create',compact('formes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //dd($data);
        return redirect(route('program.entreprises.index'));
    }
    ...
    public function show(string $token)
    {
        ...
        //dd($groups);
        $mr = $groups;
        $programs = User::where('role_id',14)->where('agence_id',auth()->user()->agence_id)->get();
        $programmes = Programme::all();
        return view('/Program/Companies/show',compact('item','mr','programmes','programs'));
    ...
    public function createTiersPhysique(string $token)
    {
        ...
        return view('/Program/Companies/tiers_physique',compact('item'));
    }
    ...
    public function createTiersMorale(string $token)
    {
        ...
        $formes = Forme::all();
        return view('/Program/Companies/tiers_morale',compact('item','formes'));
    }
    ...
    public function saveTiersPhysique(Request $request)
    {
        ...
        Session::flash('success','Enregistrement effectué avec succès!');
        return redirect(route('program.entreprises.show',$token));
    }
    ...
    public function createQuestionnaire(string $token)
    {
        ...
        return view('/Program/Companies/questionnaire',compact('item','criteres'));
    }
