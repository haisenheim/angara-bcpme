...
class SortieController extends ExtendedController
{
    ...
    {
        //
        return view('Cooperative/Sorties/index');
    }

    public function fetchAll(){
        $items = Sortie::where('cooperative_id',auth()->user()->cooperative_id)->get();
    ...
    public function create()
    {
        ...
        return view('Cooperative.Sorties.create',compact('agents','entrepots','gammes','exploitants'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('cooperative.Sorties.index'));
    }
