...
class InstructionController extends Controller
{
    ...
    public function index()
    {
        //
        $items = Libelle::all();
        return view('/Gestionnaire/Libelles/index')->with(compact('items'));
    }

    public function getCritereParamsForm(){
        $criteres = Http::get('http://localhost:8080/test');
        $items = json_decode($criteres->body(),true);
        return view('/Gestionnaire/Instruction/params')->with(compact('items'));
    }

    public function createDossier(){
        return view('/Gestionnaire/Instruction/create');
    }
    ...
    public function loadDsf(){
       ...
       dd($ret->body());
        return redirect(route('gestionnaire.instruction.dossier',$dossier_id));
    }
    ...
    public function getDossier($id){
       ...
       // dd($note3);
        return view('/Gestionnaire/Instruction/dossier',compact('id','note3'));
    }
