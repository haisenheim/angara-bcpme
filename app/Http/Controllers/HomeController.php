...
class HomeController extends ExtendedController
{
    ...
    public function index()
    {
        ...
        if ($user) {
            ...
            // Cast en int avec fallback codé en dur sur la valeur par défaut du
            // référentiel BC-PME. Garantit que la redirection fonctionne même si
            // `config:cache` a figé un snapshot sans le fichier `config/angara.php`.
