...
class SortieController extends ExtendedController
{
    ...
    {
        //
        return view('Tenant/Rstock/Sorties/index');
    }
    ...
    public function create()
    {
        ...
        return view('Tenant.Rstock.Sorties.create',compact('agents','entrepots','gammes','exploitants'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('rstock.Sorties.index'));
    }
