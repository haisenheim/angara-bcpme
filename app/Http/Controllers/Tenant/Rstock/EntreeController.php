...
class EntreeController extends ExtendedController
{
    ...
    {
        //
        return view('Tenant/Rstock/Entrees/index');
    }
    ...
    public function create()
    {
        ...
        return view('Tenant/Rstock.Entrees.create',compact('agents','entrepots','gammes','exploitants'));
    }
	...
	public function show($token)
	{
        ...
        //dd($wallets);
        return view('Tenant/Rstock.Entrees.show',compact('item'));
	}
