...
class MemberController extends ExtendedController
{
    ...
    public function index()
    {
        ...
        $niveaux = Niveau::all();
        return view('Tenant/Rstock/Members/index')->with(compact('villages','items','niveaux'));
    }
	...
	public function show($token)
	{
		...
		return view('Tenant/Rstock/Members/show')->with(compact('item','parts','paiements','plateformes','villages'));
	}
