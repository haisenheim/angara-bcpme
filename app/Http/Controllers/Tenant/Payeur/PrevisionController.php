...
class PrevisionController extends ExtendedController
{
    ...
    {
        //
        return view('Tenant/Payeur/Previsions/index');
    }
    ...
    public function create()
    {
        ...
        return view('Tenant/Payeur.Previsions.create',compact('agents','entrepots','gammes','exploitants'));
    }
	...
	public function show($token)
	{
        ...
        //dd($wallets);
        return view('Tenant/Payeur.Previsions.show',compact('item'));
	}
