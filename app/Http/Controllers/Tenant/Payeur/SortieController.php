...
class SortieController extends ExtendedController
{
    ...
    {
        //
        return view('Tenant/Payeur/Sorties/index');
    }
    ...
    public function create()
    {
        ...
        return view('Tenant.Payeur.Sorties.create',compact('agents','entrepots','gammes','exploitants'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('payeur.Sorties.index'));
    }
