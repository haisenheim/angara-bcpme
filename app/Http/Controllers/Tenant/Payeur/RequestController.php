...
class RequestController extends ExtendedController
{
    ...
    public function index()
    {
        ...
        return view('Tenant/Payeur/Requests/index')->with(compact('items'));
    }
    ...
    public function create()
    {
        ...
        return view('Tenant/Payeur/Requests/create')->with(compact('items','caisses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($data['caisse_id']){
            ...
            $req = StructurationRequest::create($data);
            Session::flash('success','Requete envoyée avec succès!');
            //return redirect(route('payeur.requests.index'));
        }
