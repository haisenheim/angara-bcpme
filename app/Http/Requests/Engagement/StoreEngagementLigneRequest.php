...
class StoreEngagementLigneRequest extends FormRequest
{
    ...
    {
        return [
            'engagement_categorie_id' => [
                'required', 'integer',
                'exists:central_app_mysql.engagement_categories,id',
            ],
    ...
    {
        return [
            'engagement_categorie_id' => (int) $this->input('engagement_categorie_id'),
