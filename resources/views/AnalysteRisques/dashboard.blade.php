...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="h4 mb-0" id="anrx-dossiers"><span class="spinner-border spinner-border-sm" role="status"></span></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="card shadow-sm h-100 border-start border-4 border-primary">
                    <div class="card-body">
                        ...
                        <div class="h4 mb-0" id="anrx-a-traiter"><span class="spinner-border spinner-border-sm" role="status"></span></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="card shadow-sm h-100 border-start border-4 border-success">
                    <div class="card-body">
                        <div class="text-muted small">Soumis au resp. risques</div>
                        <div class="h4 mb-0" id="anrx-soumis"><span class="spinner-border spinner-border-sm" role="status"></span></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="card shadow-sm h-100 border-start border-4 border-warning">
                    <div class="card-body">
                        ...
                        <div class="h4 mb-0" id="anrx-retard"><span class="spinner-border spinner-border-sm" role="status"></span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm mt-3">
            <div class="card-header bg-transparent d-flex align-items-center justify-content-between">
                ...
                <a class="btn btn-sm btn-outline-primary" href="{{ route('analyste-risques.dossiers.index') }}">Voir tout</a>
            </div>
            <div class="card-body">
                <div id="anrx-todos" class="list-group list-group-flush">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            AngaraLoadDashboardStats(@json(route('analyste-risques.dashboard.stats')), {
                dossiers_count: 'anrx-dossiers',
                a_traiter: 'anrx-a-traiter',
                soumis_rerx: 'anrx-soumis',
                en_retard: 'anrx-retard',
            });

            fetch(@json(route('analyste-risques.dashboard.todos')), {
                ...
                .then(function (data) {
                    const container = document.getElementById('anrx-todos');
                    if (!container) return;
                    ...
                    rows.forEach(function (row) {
                        const href = row.token ? @json(url('/analyste-risques/dossiers')) + '/' + row.token : '#';
