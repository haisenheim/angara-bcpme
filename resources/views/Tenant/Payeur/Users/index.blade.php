                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            @if($item->active)
                                                <li><a class="dropdown-item" href="{{ route('payeur.user.disable',$item->id) }}">Verrouiller</a></li>
                                            @else
                                                <li><a class="dropdown-item" href="{{ route('payeur.user.enable',$item->id) }}">Activer</a></li>
                                            @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('payeur.users.store') }}" method="post">
                        @csrf
                            <div class="">
                                <div class="">
                                    <label for="">NOM</label>
