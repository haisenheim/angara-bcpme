                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="{{ route('payeur.members.show',$item->token) }}">Afficher</a></li>
                                    </ul>
                                 </div>
                            </td>
                        </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('payeur.members.store') }}" method="post">
                        @csrf
                        <fieldset>
