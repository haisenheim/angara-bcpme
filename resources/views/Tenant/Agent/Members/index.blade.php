...
@section('actions')
    <a href="#" data-bs-target="#addModal" data-bs-toggle="modal" class="btn btn-primary btn-sm p-2 fs-5"><i class="demo-pli-add me-2 fs-5"></i> Créer un membre</a>
@endsection

@section('page-header')
    <div>
        <h5 class="page-title mb-0 mt-2">Membres </h5>
        <p class="lead">Liste des membres  </p>
    </div>
@endsection
                ...
                <tbody>
                    @foreach($items as $item)
                        <tr class="border border-2 ">
                            ...
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-xs btn-light dropdown-toggle hstack gap-2 p-1 fs-6 fw-bold" data-bs-toggle="dropdown" aria-expanded="false">
                                       Actions
                                       <span class="vr"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="{{ route('agent.members.show',$item->token) }}">Afficher</a></li>
                                    </ul>
                                 </div>
                            </td>
                        </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('agent.members.store') }}" method="post">
                        @csrf
                        <fieldset>
