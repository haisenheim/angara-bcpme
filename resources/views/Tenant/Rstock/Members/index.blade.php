                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="{{ route('rstock.members.show',$item->token) }}">Afficher</a></li>
                                    </ul>
                                 </div>
                            </td>
                        </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('rstock.members.store') }}" method="post">
                        @csrf
                        <fieldset>
