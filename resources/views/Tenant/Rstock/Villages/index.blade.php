...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active" aria-current="page">Liste des villages de l'arrondissement</li>
    </ol>
 </nav>
@endsection
...
@section('page-header')
    <div>
        ...
        <p class="lead">Liste de tous les villages de l'arrondissement</p>
    </div>
@endsection
            ...
            <table class="table table-sm">
                ...
                <tbody>
                    @foreach($villages as $item)
                        <tr>
                            <td><a href="{{ route('rstock.villages.show',$item->id) }}">{{ $item->name }}</a></td>
                            <td>{{ $item->latitude }}</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('rstock.villages.store') }}" method="post">
                        @csrf
