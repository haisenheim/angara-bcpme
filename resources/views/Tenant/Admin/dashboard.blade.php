            ...
            <div class="w-300px">
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-footer">
                        <span style="float: right" class="badge bg-danger">{{ number_format($stock/1000,1,',','.') }} tonnes</span>
                    </div>
                </div>
                ...
                <div class="d-flex gap-1">
                    <div class="card bg-light flex-fill text-primary">
                        <div class="card-body text-center flex-fill">
                            ...
                            <div>
                                <span>{{ number_format($exploitants->count(),0,',','.') }}</span> <span>Membres</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-teal text-white flex-fill">
                        <div class="card-body text-center">
                            ...
                            <div class="fs-5">
                                <span id="text-agents">{{ $agents->count() }}</span> <span>Agents</span>
                            </div>
                        </div>
                    </div>
                </div>
