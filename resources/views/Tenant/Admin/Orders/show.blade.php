        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('admin.invoice.part.add') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="addPayModal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('admin.invoice.part.paiement') }}" method="post">
                        @csrf
