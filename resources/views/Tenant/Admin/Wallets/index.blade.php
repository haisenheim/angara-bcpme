                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu analyse">
                                        ...
                                        <li><a class="dropdown-item r-btn" data-token="{{ $item->token }}" data-bs-target="#rechargeModal" data-bs-toggle="modal"  href="#">Recharger</a></li>
                                            <li><a class="dropdown-item"  href="{{ route('admin.wallet.disable',$item->token) }}">Verrouiller</a></li>
                                        @else
                                            <li><a class="dropdown-item"  href="{{ route('admin.wallet.enable',$item->token) }}">Deverrouiller</a></li>
                                        @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('admin.wallets.store') }}" method="post">
                        @csrf
                        <div class="">
                            <div class="flex-fill">
    ...
    <div class="modal fade" id="rechargeModal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('admin.wallet.recharge') }}" method="post">
                        @csrf
