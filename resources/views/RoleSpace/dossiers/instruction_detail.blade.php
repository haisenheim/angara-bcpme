...
@section('actions')
    ...
    <a href="{{ route($space['route'].'.dossiers.analyse-critique', $item->token) }}" class="btn btn-sm btn-outline-primary">
...
<div class="container-fluid">
    <div class="alert alert-light border mb-4">
        ...
        @else
            <strong>Consultation réservée au responsable exploitation</strong> après transmission du dossier par l’analyste financier.
        @endif
