...
@section('actions')
    <x-page-actions-dropdown>
        <li>
            <a href="{{ route('admin.entreprises.create') }}" class="dropdown-item">
                <i class="demo-pli-add me-2"></i>Nouvelle entreprise
            </a>
        </li>
    </x-page-actions-dropdown>
@endsection
...
@section('page-header')
    <div>
        ...
        <p class="text-body-secondary mb-0 mt-1">Vue nationale des dossiers prospect</p>
    </div>
@endsection
        ...
        <div class="card-body py-3">
            ...
            <div class="row g-3 align-items-end mt-1 pt-2 border-top border-light-subtle">
                ...
                <div class="col-12 col-md-auto ms-md-auto pt-1 pt-md-0">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="admin-prospects-actions" data-bs-toggle="dropdown" aria-expanded="false">Actions</button>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="admin-prospects-actions">
...
document.addEventListener('DOMContentLoaded', function() {
    const baseUrl = "{{ url('admin/entreprises') }}";
    const paginatedUrl = "{{ route('admin.prospects.paginated') }}";
    const statsUrl = "{{ route('admin.prospects.stats') }}";
    const filterOptionsUrl = "{{ route('admin.prospects.filter-options') }}";
    const exportUrl = "{{ route('admin.prospects.export') }}";
