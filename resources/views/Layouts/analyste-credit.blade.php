...
<div class="mainnav__categoriy py-3 mb-0">
    <ul class="mainnav__menu nav flex-column gap-2">
        <li class="nav-item">
            <a href="{{ route('analyste-credit.dashboard') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'analyste-credit.dashboard') ? 'active' : '' }}"><i class="bi bi-house-door fs-4 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    <h6 class="mainnav__caption mt-0 px-3 fw-bold">ENGAGEMENTS</h6>
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('analyste-credit.dossiers.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'analyste-credit.dossiers') ? 'active' : '' }}"><i class="bi bi-folder2 fs-5 me-2"></i>
