...
?>
    <div>
        <div class="d-flex gap-3">
            ...
            <div>
                <span>-</span>
                <strong><span class="badge bg-white text-dark fs-6">gestionnaire de compte</span></strong>
            </div>
        </div>
    </div>
...
<div class="mainnav__categoriy py-3">
    <h6 class="mainnav__caption mt-0 px-3 fw-bold">GESTION DES FILIERES</h6>
    <ul class="mainnav__menu nav flex-column">

        <li class="nav-item">
            <a href="{{ route('structuration_gestionnaire.comptes.index') }}" class="nav-link mininav-toggle {{ $active==2?'active':'' }}"><i class="pli-file fs-2 me-2"></i>
                <span class="nav-label mininav-content ms-1">COMPTES</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('structuration_gestionnaire.requests.index') }}" class="nav-link mininav-toggle {{ $active==3?'active':'' }}"><i class="pli-phone fs-2 me-2"></i>
