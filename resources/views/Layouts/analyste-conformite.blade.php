...
<div class="mainnav__categoriy py-3 mb-0">
    <ul class="mainnav__menu nav flex-column gap-2">
        <li class="nav-item">
            <a href="{{ route('analyste-conformite.dashboard') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'analyste-conformite.dashboard') ? 'active' : '' }}"><i class="demo-pli-home fs-3 me-2"></i>
