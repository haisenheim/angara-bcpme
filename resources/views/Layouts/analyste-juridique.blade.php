...
<div class="mainnav__categoriy py-3 mb-0">
    <ul class="mainnav__menu nav flex-column gap-2">
        <li class="nav-item">
            <a href="{{ route('analyste-juridique.dashboard') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'analyste-juridique.dashboard') ? 'active' : '' }}"><i class="demo-pli-home fs-3 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('analyste-juridique.dossiers.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'analyste-juridique.dossiers') ? 'active' : '' }}"><i class="demo-psi-folder fs-2 me-2"></i>
