...
<div class="mainnav__categoriy py-3 mb-0">
    <ul class="mainnav__menu nav flex-column gap-2">
        <li class="nav-item">
            <a href="{{ route('chef-filiere.dashboard') }}" class="nav-link mininav-toggle {{ $r === 'chef-filiere.dashboard' ? 'active' : '' }}"><i class="demo-pli-home fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Tableau de bord</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('chef-filiere.qualifications.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'chef-filiere.qualifications.') ? 'active' : '' }}"><i class="demo-psi-check-mark fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Qualifications en attente</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('chef-filiere.clients.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'chef-filiere.clients.') ? 'active' : '' }}"><i class="demo-pli-building fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Clients</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('chef-filiere.programmes.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'chef-filiere.programmes.') ? 'active' : '' }}"><i class="demo-psi-file-word fs-3 me-2"></i>
