...
<div class="mainnav__categoriy py-3 mb-0">
    <ul class="mainnav__menu nav flex-column gap-2">
        <li class="nav-item">
            <a href="{{ route('rerx.dashboard') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'rerx.dashboard') ? 'active' : '' }}"><i class="demo-pli-home fs-3 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('rerx.dossiers.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'rerx.dossiers') ? 'active' : '' }}"><i class="demo-psi-folder fs-2 me-2"></i>
                <span class="nav-label mininav-content ms-1">Dossiers (depuis engagements)</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('rerx.entreprises.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'rerx.entreprises') ? 'active' : '' }}"><i class="pli-bank fs-2 me-2"></i>
