...
<div class="mainnav__categoriy py-3 mb-0">
    <ul class="mainnav__menu nav flex-column gap-2">
        <li class="nav-item">
            <a href="{{ route('reng.dashboard') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'reng.dashboard') ? 'active' : '' }}"><i class="bi bi-house-door fs-4 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('reng.dossiers.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'reng.dossiers') ? 'active' : '' }}"><i class="bi bi-folder2 fs-5 me-2"></i>
                <span class="nav-label mininav-content ms-1">Dossiers d’instruction</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('reng.entreprises.index') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'reng.entreprises') ? 'active' : '' }}"><i class="bi bi-bank fs-5 me-2"></i>
