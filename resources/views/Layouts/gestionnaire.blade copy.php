...
?>
     ...
     <div class="mainnav__categoriy py-3 mb-4">
        ...
        <!-- Link with submenu -->
         <li class="nav-item has-sub">
            ...
            <ul class="mininav-content nav collapse">
                <li class="nav-item">
                    <a href="{{ route('gestionnaire.dossiers.index') }}" class="nav-link {{ $active==201?'active':'' }}">DOSSIERS D'INSTRUCTION</a>
                </li>
                <li class="nav-item">
        ...
        <!-- END : Link with submenu -->
           ...
           <li class="nav-item">
                <a href="{{ route('gestionnaire.programmes.index') }}" class="nav-link mininav-toggle {{ $active==3?'active':'' }}"><i class="pli-affiliate fs-2 me-2"></i>
            ...
            <li class="nav-item">
                <a href="{{ route('gestionnaire.entreprises.index') }}" class="nav-link mininav-toggle {{ $active==4?'active':'' }}"><i class="pli-bank fs-2 me-2"></i>
                    <span class="nav-label mininav-content ms-1">ENTREPRISES</span>
                </a>
            </li>

            <li class="nav-item">
                <a href="{{ route('gestionnaire.entreprises.prospects') }}" class="nav-link mininav-toggle {{ $active==5?'active':'' }}"><i class="pli-phone-2 fs-2 me-2"></i>
            ...
            <li class="nav-item has-sub">
                <a href="#" class="mininav-toggle nav-link {{ ($active>600&&$active<700)?'active':'' }}"><i class="pli-leafs fs-5 me-2"></i>
                    <span class="nav-label ms-1">STRUCTURATION</span>
                </a>
                <!-- Settings submenu list -->
                <ul class="mininav-content nav collapse">
                    <li class="nav-item">
