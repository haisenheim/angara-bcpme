...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
       ...
       <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="{{ route('ca.workflow.prospects.index') }}" class="nav-link mininav-toggle {{ $active==406?'active':'' }}"><i class="pli-check fs-2 me-2"></i>
                <span class="nav-label mininav-content ms-1">Arbitrage prospects</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('ca.workflow.instructions.index') }}" class="nav-link mininav-toggle {{ $active==407?'active':'' }}"><i class="pli-folder fs-2 me-2"></i>
                <span class="nav-label mininav-content ms-1">Validations instruction</span>
            </a>
        </li>
