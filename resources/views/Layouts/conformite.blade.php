...
<div class="mainnav__categoriy py-3 mb-0">
    <ul class="mainnav__menu nav flex-column gap-2">
        <li class="nav-item">
            <a href="{{ route('conformite.dashboard') }}" class="nav-link mininav-toggle {{ str_starts_with($r, 'conformite.dashboard') ? 'active' : '' }}"><i class="demo-pli-home fs-3 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('conformite.prospects.index') }}" class="nav-link mininav-toggle {{ $r === 'conformite.prospects.index' ? 'active' : '' }}"><i class="demo-psi-check-mark fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">File avis conformité</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('conformite.prospects.treated') }}" class="nav-link mininav-toggle {{ $r === 'conformite.prospects.treated' ? 'active' : '' }}"><i class="demo-pli-folder fs-3 me-2"></i>
