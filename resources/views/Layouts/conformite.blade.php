...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('conformite.tous-prospects.index') }}" class="nav-link mininav-toggle {{ $r === 'conformite.tous-prospects.index' ? 'active' : '' }}"><i class="bi bi-people fs-5 me-2"></i>
                <span class="nav-label mininav-content ms-1">Tous les prospects (soumis)</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('conformite.entreprises.index') }}" class="nav-link mininav-toggle {{ $r === 'conformite.entreprises.index' ? 'active' : '' }}"><i class="bi bi-bank fs-5 me-2"></i>
                <span class="nav-label mininav-content ms-1">Entreprises &amp; clients</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('conformite.dossiers.index') }}" class="nav-link mininav-toggle {{ $r === 'conformite.dossiers.index' ? 'active' : '' }}"><i class="bi bi-folder2-open fs-5 me-2"></i>
