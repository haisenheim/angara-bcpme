...
<div>
 ...
 <div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
       ...
       <li class="nav-item">
           <a href="{{ route('cooperative.requests.create') }}" class="nav-link mininav-toggle {{ $active==6?'active':'' }}"><i class="pli-bell fs-3 me-2"></i>
               <span class="nav-label mininav-content ms-1">Nouvel appel de fonds</span>
           </a>
       </li>

       <li class="nav-item">
            <a href="{{ route('cooperative.requests.index') }}" class="nav-link mininav-toggle {{ $active==7?'active':'' }}"><i class="pli-coins-3 fs-3 me-2"></i>
