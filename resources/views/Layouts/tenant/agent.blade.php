...
<div>
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('agent.dashboard') }}" class="nav-link mininav-toggle {{ $active==1?'active':'' }}"><i class="pli-monitor-analytics fs-3 me-2"></i>
 ...
 <div class="mainnav__categoriy py-3">
     ...
     <ul class="mainnav__menu nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ route('agent.previsions.index') }}" class="nav-link mininav-toggle {{ $active==2?'active':'' }}"><i class="pli-calendar fs-3 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ route('agent.members.index') }}" class="nav-link mininav-toggle {{ $active==3?'active':'' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('agent.villages.index') }}" class="nav-link mininav-toggle {{ $active==4?'active':'' }}">
                {{-- <i class="pli-conference fs-2 me-2"></i> --}}
        ...
        <li class="nav-item">
            <a href="{{ route('agent.entrepots.index') }}" class="nav-link mininav-toggle {{ $active==5?'active':'' }}"><i class="pli-server fs-2 me-2"></i>
