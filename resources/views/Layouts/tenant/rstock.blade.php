...
<div>
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('rstock.dashboard') }}" class="nav-link mininav-toggle {{ $active==1?'active':'' }}"><i class="pli-monitor-analytics fs-3 me-2"></i>
 ...
 <div class="mainnav__categoriy py-3">
     ...
     <ul class="mainnav__menu nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ route('rstock.entrees.create') }}" class="nav-link mininav-toggle {{ $active==2?'active':'' }}"><i class="pli-full-view fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Nouvelle entrée en stock</span>
            </a>
        </li>

        <li class="nav-item">
            <a href="{{ route('rstock.sorties.create') }}" class="nav-link mininav-toggle {{ $active==3?'active':'' }}"><i class="pli-maximize fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Nouvelle sortie de stock</span>
            </a>
        </li>

        <li class="nav-item">
            <a href="{{ route('rstock.entrees.index') }}" class="nav-link mininav-toggle {{ $active==4?'active':'' }}"><i class="pli-arrow-inside fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Historique des entrées</span>
            </a>
        </li>

        <li class="nav-item">
            <a href="{{ route('rstock.sorties.index') }}" class="nav-link mininav-toggle {{ $active==5?'active':'' }}"><i class="pli-arrow-outside fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Historique des sorties</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('rstock.previsions.index') }}" class="nav-link mininav-toggle {{ $active==10?'active':'' }}"><i class="pli-calendar fs-3 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ route('rstock.members.index') }}" class="nav-link mininav-toggle {{ $active==3?'active':'' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('rstock.villages.index') }}" class="nav-link mininav-toggle {{ $active==4?'active':'' }}">
                {{-- <i class="pli-conference fs-2 me-2"></i> --}}
        ...
        <li class="nav-item">
            <a href="{{ route('rstock.entrepots.index') }}" class="nav-link mininav-toggle {{ $active==5?'active':'' }}"><i class="pli-server fs-2 me-2"></i>
