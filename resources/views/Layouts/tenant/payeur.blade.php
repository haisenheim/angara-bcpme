...
<div>
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('payeur.dashboard') }}" class="nav-link mininav-toggle {{ $active==1?'active':'' }}"><i class="pli-monitor-analytics fs-3 me-2"></i>
 ...
 <div class="mainnav__categoriy py-3">
     ...
     <ul class="mainnav__menu nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ route('payeur.entrees.index') }}" class="nav-link mininav-toggle {{ $active==4?'active':'' }}"><i class="pli-arrow-inside fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Historique des entrées</span>
            </a>
        </li>

        <li class="nav-item">
            <a href="{{ route('payeur.sorties.index') }}" class="nav-link mininav-toggle {{ $active==5?'active':'' }}"><i class="pli-arrow-outside fs-3 me-2"></i>
                <span class="nav-label mininav-content ms-1">Historique des sorties</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('payeur.previsions.index') }}" class="nav-link mininav-toggle {{ $active==10?'active':'' }}"><i class="pli-calendar fs-3 me-2"></i>
 ...
 <div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ route('payeur.caisses.index') }}" class="nav-link mininav-toggle {{ $active==9?'active':'' }}"><i class="pli-atm fs-3 me-2"></i>
...
<div class="mainnav__categoriy py-3">
    ...
    <ul class="mainnav__menu nav flex-column">
        <li class="nav-item">
            <a href="{{ route('payeur.members.index') }}" class="nav-link mininav-toggle {{ $active==9?'active':'' }}"><i class="pli-farmer fs-2 me-2"></i>
