    ...
    <div class="d-flex gap-2">
        <div class="card w-300px">
            <div class="card-body">
                ...
                <p><a href="{{ route('sectoriel.entreprises.show',$item->entreprise?->token) }}">Cliquer ici pour voir son dossier d'entreprise</a></p>
            </div>
        </div>
        <div class="flex-fill">
            <div class="tab-base">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <li><a class="dropdown-item" href="{{ route('sectoriel.members.show',$meb->token) }}">Afficher</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                @foreach($item->entrepots as $item)
                                    <tr>
                                        <td><a href="{{ route('sectoriel.entrepots.show',$item->token) }}">{{ $item->name }}</a></td>
