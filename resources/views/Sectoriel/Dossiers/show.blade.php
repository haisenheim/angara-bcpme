...
<div class="btn-group">
    ...
    <ul class="dropdown-menu analyse">
        <li><a data-sequence="7" class="dropdown-item" data-bs-target="#report1Modal" data-bs-toggle="modal" href="#">Conclusions motivées, recommandations du sectoriel</a></li>
    </ul>
</div>
@endsection
...
<div>
    ...
    <script>
            ...
            var url = "{{ route('sectoriel.instruction.critere.choices') }}"
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    //window.location.replace('/sectoriel/instruction/dossier/'+dossier_id)
                },
                //processData: false,
               // contentType: false
            } );
        })
        //var url = "{{ route('sectoriel.instruction.dsf') }}"
