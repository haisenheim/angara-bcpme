                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <li><a class="dropdown-item" href="{{ route('sectoriel.members.show',['token'=>$meb->token,'tenant_id'=>$item->token]) }}">Afficher</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                @foreach($data['entrepots'] as $ent)
                                    <tr>
                                        <td><a href="{{ route('sectoriel.entrepots.show',['token'=>$ent->token,'tenant_id'=>$item->token]) }}">{{ $ent->name }}</a></td>
                            ...
                            <table id="entreesTable" class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="fs-6 border">
                                        ...
                                        <td><a class="btn-link link-danger" href="{{ route('sectoriel.members.show',$e->exploitant->token) }}">{{ $e->exploitant?->name}}</a></td>
                                        <td>{{ $e->agent?->name}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <table id="paiementsTable" class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="border fs-6">
                                    ...
                                    <td><a class="link-danger btn-link" href="{{ route('sectoriel.cooperative.entrees.show',$p->entree->token) }}">{{$p->entree->name}}</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.cooperative.caisse.add') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="walletModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.wallets.store') }}" method="post">
                        @csrf
                        <div class="d-flex gap-2 flex-grow mt-3">
                            <input type="hidden" value="{{$item->id}}" name="cooperative_id">
                            <div class="flex-fill">
    ...
    <div class="modal fade" id="exportPaiementsModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('sectoriel.cooperative.paiements.export') }}" method="post">
                        @csrf
                        <div class="">
                            <input type="hidden" value="{{$item->id}}" name="cooperative_id">
                            <fieldset>
    ...
    <div class="modal fade" id="exportEntreesModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('sectoriel.cooperative.entrees.export') }}" method="post">
                        @csrf
                        <div class="">
                            <input type="hidden" value="{{$item->id}}" name="cooperative_id">
                            <fieldset>
