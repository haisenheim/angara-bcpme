...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="{{ route('sectoriel.entreprise.questionnaire',$item->token) }}">Editer le questionnaire de mise en relation</a></li>
        <li><a class="dropdown-item" href="{{ route('sectoriel.entreprise.physique.create',$item->token) }}">Ajouter un tiers personne physique</a></li>
        <li><a class="dropdown-item" href="{{ route('sectoriel.entreprise.morale.create',$item->token) }}">Ajouter un tiers personne morale</a></li>
        ...
        <li><a class="dropdown-item" href="{{ route('sectoriel.entreprises.edit',$item->token) }}">Editer des information de l'entreprise</a></li>
        <li><a class="dropdown-item" href="{{ route('sectoriel.entreprise.get.engagements',$item->token) }}">Etat des engagement de l'entreprise</a></li>
    </ul>
 </div>
@endsection
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($item->dossiers as $dossier)
                                        <tr>
                                            <th><a href="{{ route('sectoriel.programmes.show',$dossier->programme?->token) }}">{{ $dossier->programme?->name }}</a></th>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ route('sectoriel.dossiers.show',$dossier->token) }}">Afficher le dossier</a></li>
                                                        <li><a class="dropdown-item" href="{{ route('sectoriel.programmes.show',$dossier->programme?->token) }}">Afficher le programme</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.entreprise.programme.save') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="addAppuiModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.entreprise.appui.save') }}" method="post">
                        @csrf
                        <input type="hidden" name="entreprise_id" value="{{ $item->id }}">
                            <div class="">
                                <div class="form-group">
    ...
    <div class="modal fade" id="addElementModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.entreprise.element.save') }}" method="post">
                        @csrf
                        <input type="hidden" name="entreprise_id" value="{{ $item->id }}">
                            <div class="">
                                <div class="form-group">
