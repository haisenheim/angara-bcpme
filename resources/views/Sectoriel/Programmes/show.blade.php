        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.programme.composante.save') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="addIndModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.programme.resultat.save') }}" method="post">
                        @csrf
                        <input type="hidden" name="token" value="{{ $item->token }}">
                        <input type="hidden" name="programme_id" value="{{ $item->id }}">
                            <div class="">
