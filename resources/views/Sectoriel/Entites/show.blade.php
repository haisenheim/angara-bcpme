...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="{{ route('sectoriel.entite.questionnaire',$item->token) }}">Editer le questionnaire de mise en relation</a></li>
        <li><a class="dropdown-item" href="{{ route('sectoriel.entite.physique.create',$item->token) }}">Ajouter un tiers personne physique</a></li>
        <li><a class="dropdown-item" href="{{ route('sectoriel.entite.morale.create',$item->token) }}">Ajouter un tiers personne morale</a></li>
        ...
        <li><a class="dropdown-item" href="{{ route('sectoriel.entites.edit',$item->token) }}">Editer des information de l'entité</a></li>
        <li><a class="dropdown-item" href="{{ route('sectoriel.entreprise.get.engagements',$item->token) }}">Etat des engagement de l'entité</a></li>
    </ul>
 </div>
@endsection
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.entite.programme.save') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="addAppuiModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.entite.appui.save') }}" method="post">
                        @csrf
                        <input type="hidden" name="entreprise_id" value="{{ $item->id }}">
                            <div class="">
                                <div class="form-group">
    ...
    <div class="modal fade" id="addElementModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('sectoriel.entite.element.save') }}" method="post">
                        @csrf
                        <input type="hidden" name="entreprise_id" value="{{ $item->id }}">
                            <div class="">
                                <div class="form-group">
