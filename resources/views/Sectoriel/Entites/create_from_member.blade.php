    ...
    <div class="d-flex justify-content-center">
        <div class="d-flex gap-0" style="width: 900px">
            ...
            <div class="card flex-fill">
                <div class="card-body">
                    <form action="{{ route('sectoriel.entites.store') }}" method="post" id="my-form">
                        @csrf
                        ...
                        <input type="hidden" id="producteur_id" value="{{ $item->id }}" name="producteur_id">
                        <section data-step="step-1">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label for="">Numéro Mobile Money</label>
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <div class="form-group flex-fill">
                                    <label for="">Emplois permanents</label>
                                    <input required  type="number" id="nb_personnel_permanent"  name="nb_personnel_permanent" placeholder="Nombre d'employés permanents" class="form-control">
                                </div>
                                <div class="form-group flex-fill">
                                    <label for="">Emplois saisonniers</label>
                                    <input required  type="number" id="nb_personnel_saisonier"  name="nb_personnel_saisonier" placeholder="Nombre d'employés saisonniers" class="form-control">
                                </div>
                            </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-7 col-sm-12">
                                        <label for="">Nom</label>
                                        <input required type="text" id="manager" value="{{$item->name}}" placeholder="Nom et prenom du dirigeant" name="manager" class="form-control">
                                    </div>
                                ...
                                <div class="d-flex gap-2">
                                    <div class="form-group w-30">
                                        ...
                                        <input required type="text" id="manager_contact" value="{{ $item->phone }}" placeholder="Contact du dirigeant" name="manager_contact" class="form-control">
                                    </div>
                                    <div class="form-group w-25">
                                    ...
                                    <div class="form-group flex-fill mr-2">
                                        ...
                                        <input required type="date" id="manager_dtn" value="{{ $item->dtn }}"  name="manager_dtn" class="form-control">
                                    </div>
                                    <div class="form-group w-25">
                                        <label for="">Est-il le promoteur ? </label>
                                        <div class="">
                                            <div class="form-check form-check-inline">
