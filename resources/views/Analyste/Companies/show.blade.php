...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="{{ route('analyste.entreprise.questionnaire',$item->token) }}">Editer le questionnaire de mise en relation</a></li>
        <li><a class="dropdown-item" href="{{ route('analyste.entreprise.physique.create',$item->token) }}">Ajouter un tiers personne physique</a></li>
        <li><a class="dropdown-item" href="{{ route('analyste.entreprise.morale.create',$item->token) }}">Ajouter un tiers personne morale</a></li>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($item->dossiers as $dossier)
                                        <tr>
                                            <th><a href="{{ route('analyste.programmes.show',$dossier->programme?->token) }}">{{ $dossier->programme?->name }}</a></th>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ route('analyste.dossiers.show',$dossier->token) }}">Afficher le dossier</a></li>
                                                        <li><a class="dropdown-item" href="{{ route('analyste.programmes.show',$dossier->programme?->token) }}">Afficher le programme</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('analyste.entreprise.programme.save') }}" method="post">
                        @csrf
