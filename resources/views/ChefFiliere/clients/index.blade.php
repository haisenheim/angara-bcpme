...
<div class="cf-page">
    <div class="cf-hero mb-4">
        ...
        <p class="cf-hero__lead">Suivez l’état de qualification et ouvrez chaque dossier pour le détail.</p>
    ...
    <div class="cf-panel">
        <div class="cf-panel__toolbar">
            <p class="cf-panel__toolbar-label mb-0">Répertoire</p>
        </div>
            ...
            <table class="table cf-table mb-0 align-middle">
                <thead>
                    <tr>
                        ...
                        <th scope="col">État qualification</th>
                ...
                <tbody>
                    @forelse($items as $item)
                        @php
                            ...
                            $soumis = $eer && $eer->programmes_submitted_at;
                        @endphp
                        <tr>
                            ...
                            <td>
                                @if($soumis)
                                    <span class="badge rounded-pill text-bg-info bg-opacity-75">Soumis au chef d'agence</span>
                                @else
                                    <span class="badge rounded-pill text-bg-warning text-dark">Qualification à poursuivre</span>
                                @endif
                            </td>
