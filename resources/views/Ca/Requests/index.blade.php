                ...
                <tbody>
                    @foreach ($items as $item)
                       <tr>
                            ...
                            <td><img src="{{ $item->cooperative?->photo }}" width="20" alt=""> {{ $item->cooperative?->name }}</td>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('ca.request.validate') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="cancelModal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('ca.request.cancel') }}" method="post">
                        @csrf
