...
@endsection
@section('actions')
    <a href="{{ route('gestionnaire.entreprises.create') }}"  class="btn btn-primary btn-sm"><i class="demo-pli-add me-2 fs-5"></i> Ajouter</a>
@endsection
    ...
    <script>
        ...
        function onFilterTextBoxChanged() {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                fetch("{{ route('gestionnaire.entreprises.all') }}")
