                        ...
                        <section data-step="step-1">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="rccm" name="rccm" value="{{ $item->rccm }}" placeholder="Numéro de registre de commerce" class="form-control">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="mm_phone" value="{{ $item->mm_phone }}" placeholder="Numéro Mobile Money" name="mm_phone" class="form-control">
                                </div>
                            </div>
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                            ...
                            <fieldset class="mt-4 pt-3 border-top">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="manager_contact" value="{{ $item->manager_contact }}" placeholder="Contact du dirigeant" name="manager_contact" class="form-control">
                                    </div>
                                    <div class="col-md-4">
