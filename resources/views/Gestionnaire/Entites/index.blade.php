...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active" aria-current="page">Liste des Entités individuelles</li>
    </ol>
 </nav>
@endsection
@section('actions')
    <a href="{{ route('gestionnaire.entites.create') }}"  class="btn btn-primary btn-sm"><i class="demo-pli-add me-2 fs-5"></i> Ajouter</a>
@endsection

@section('page-header')
    <div>
        <h5 class="page-title mb-0 mt-2">Entités individuelles</h5>
        <p class="lead">Liste de toutes les Entités individuelles</p>
    </div>
@endsection
...
@section('content')
    ...
    <script>
        ...
        function rowSelected(e){
            console.log(e.data)
            window.location.href = "entites/"+e.data.token
        }
        ...
        function onFilterTextBoxChanged() {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                fetch("{{ route('gestionnaire.entites.all') }}")
