        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="description"></p>
                    <form action="{{ route('gestionnaire.entreprise.dossier.analyse') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('gestionnaire.entreprise.set.engagement') }}" method="post">
