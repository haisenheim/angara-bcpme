...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('gestionnaire.dossiers.index') }}">Dossiers d'instruction</a></li>
...
@section('content')
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent border-0 py-3">
                    <h6 class="mb-0 fw-semibold"><i class="demo-psi-information me-2 text-primary"></i>Import DSF</h6>
                </div>
                <div class="card-body">
                    <p class="text-muted small mb-0">Les données DSF sont importées par l'analyste financier.</p>
                </div>
            </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent border-0 py-3 d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('gestionnaire.dossier.get.grille.analyse', $item->token) }}" class="btn btn-sm btn-outline-primary">
                        <i class="demo-psi-magnifi-glass me-1"></i> Grille d'analyse critique
                    </a>
                </div>
    ...
    {{-- Modale pour conclusions / recommandations du gestionnaire --}}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-muted small">Saisissez vos conclusions motivées et recommandations pour compléter la grille d'analyse critique.</p>
...
<div class="modal fade" id="critereModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('gestionnaire.instruction.critere.reponse') }}" method="post">
                    @csrf
