                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            @if($item->active)
                                                <li><a class="dropdown-item" href="{{ route('regional.user.disable',$item->token) }}">Verrouiller</a></li>
                                            @else
                                                <li><a class="dropdown-item" href="{{ route('regional.user.enable',$item->token) }}">Activer</a></li>
                                            @endif
