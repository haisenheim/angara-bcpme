...
@section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="description"></p>
                    <form action="{{ route('regional.entreprise.dossier.analyse') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="critereModal">
        <div class="modal-dialog modal-dialog-scrollable modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('regional.instruction.critere.reponse') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('regional.entreprise.set.engagement') }}" method="post">
    ...
    <script>
            ...
            var url = "{{ route('regional.instruction.critere.choices') }}"
        ...
        //var url = "{{ route('regional.instruction.dsf') }}"
