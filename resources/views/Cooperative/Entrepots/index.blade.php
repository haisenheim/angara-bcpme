            ...
            <table class="table table-sm">
                ...
                <tbody>
                    @foreach($items as $item)
                        <tr>
                            <td><a href="{{ route('cooperative.entrepots.show',$item->token) }}">{{ $item->name }}</a></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('cooperative.entrepots.store') }}" method="post">
                        @csrf
                            <div class="mb-3">
                                <div class="">
                                    <label for="">NOM</label>
