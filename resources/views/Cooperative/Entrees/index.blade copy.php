...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active" aria-current="page">Liste des entrées en stock</li>
    </ol>
 </nav>
@endsection
@section('actions')
<div class="btn-group">
    ...
    <ul class="dropdown-menu analyse">
        <li><a class="dropdown-item"  href="{{ route('cooperative.entrees.create') }}">Faire une entrée en stock</a></li>
    </ul>
</div>
@endsection
...
@section('page-header')
    <div>
        <h5 class="page-title mb-0 mt-2">Entrées en stock</h5>
        <p class="lead">Liste de toutes les entrées de stocks</p>
    </div>
@endsection
    ...
    <script>
        ...
        function onFilterTextBoxChanged() {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                fetch("{{ route('cooperative.entrees.all') }}")
