<template>
    <Display>
        <template v-slot:page-header>
            <PageHeader
                :p="description"
                :h1="'ESPACE DU SUPER ADMINISTRATEUR'"
            ></PageHeader>
        </template>
        <template v-slot:content>
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="lh-base">Contenu de la page d'administration</p>
...
export default {
    ...
    data() {
        return {
            ...
            description:
                "Bienvenu dans SKULU, la plateforme de gestion scolaire la plus revolutionnaire jamais concu!",
