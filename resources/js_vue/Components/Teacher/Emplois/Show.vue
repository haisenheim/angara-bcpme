<template>
    <Display>
        <template v-slot:breadcrumb>
            <BreadCrumb
                :link_1="{
                    name: 'GESTION DES EMPLOIS DE TEMPS',
                    path: '/emplois',
                }"
                :link_2="title"
            ></BreadCrumb>
        ...
        <template v-slot:actions>
            <li>
                <a
                    ...
                    class="dropdown-item"
                    href="#"
                    ><i class="pli-add"></i> Effectuer un pointage</a
                >
            </li>
            <li>
                <a
                    ...
                    class="dropdown-item"
                    href="#"
                    ><i class="pli-add"></i> Ajouter un chapitre</a
                >
            </li>
            <li>
                <a
                    data-bs-toggle="modal"
                    data-bs-target="#exerciceModal"
                    class="dropdown-item"
                    href="#"
                    ><i class="pli-add"></i> Ajouter un exercice</a
                >
            </li>
        </template>
                            ...
                            <div>
                                <div class="row g-1 mt-1">
                                    <div
                                        ...
                                        class="col mb-3 border-right mr-3 pr-3"
                                    >
                                        <h4
                                        ...
                                        <p class="text-info mb-3">
                                            Cette colonne specifie l'ensemble
                                            des chapitre qui seront abordes dans
                                            le cadre de ce cours
                                        </p>
                                        <div class="p-2 bg-light rounded">
                                            <!-- Upcoming Tasklist -->
                                            <div
                                                v-for="task in upcoming_chapters"
                                                :key="task.id"
                                                class="card mb-2"
                                            >
                                                <div class="card-body">
                                                    ...
                                                    <div
                                                        class="mt-4 pt-3 border-top d-flex align-items-center"
                                                    >
                                                        <div>
                                                            <button
                                                                @click="
                                    ...
                                    >
                                        ...
                                        <p class="text-warning mb-3">
                                            Cette colonne indique le ou les
                                            chapitre(s) en cours
                                        </p>
                                        <div class="p-2 bg-light rounded">
                                            <!-- In Progress Tasklist -->
                                            <div
                                                v-for="task in in_progress_chapters"
                                                :key="task.id"
                                                class="card mb-2"
                                            >
                                                <div class="card-body">
                                                    ...
                                                    <div
                                                        class="mt-4 pt-3 border-top d-flex justify-content-between"
                                                    >
                                                        <div>
                                                            <button
                                                                @click="
                                    ...
                                    <div class="col mb-3">
                                        ...
                                        <p class="text-success mb-3">
                                            Cette colonne liste tous les
                                            chapitres sont cloturés
                                        </p>
                                        <div class="p-2 bg-light rounded">
                                            <!-- Completed Tasklist -->
                                            <div
                                                v-for="task in completed_chapters"
                                                :key="task.id"
                                                class="card mb-2"
                                            >
                                                <div class="card-body">
                                                    ...
                                                    >
                                                        <a
                                                            href="#"
                                                            class="btn btn-icon btn-sm btn-link text-head"
                                                        >
                                                            <i
                                                                class="text-muted demo-pli-heart-2 fs-5 me-2"
                                                            ></i
                                                            >37k
                                                        </a>
                                                        <small
                        ...
                        <v-tabs-window-item value="two">
                            <div class="container">
                                <div
                                    ...
                                    :key="exo.id"
                                    class="p-4 border rounded-4 mb-2"
                                >
                                    <div class="">
                                        <h6 class="card-title">
                                            {{ exo.name }}
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="bg-primary p-2 rounded-2">
                                    <p class="text-center">
                                        Veuillez effectuer l'appel des etudiants
                                        et cocher tous ceux qui sont presents!
                                    </p>
                                </div>
                            </div>
                            <div class="modal-body">
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            <td>
                                                <div>
                                                    <Image
                                                        pt:image:class="img-circle rounded-circle"
                                                        :src="
                                                            src(item.etudiant)
                                                        "
                                                        alt="Image"
                                ...
                                <div>
                                    <textarea
                                        ...
                                        v-model="pv"
                                        cols="30"
                                        placeholder="Quelques notes sur le contenu de la seance ..."
                                        rows="5"
                                    ></textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button
                                    ...
                                    @click="submit"
                                >
                                    <i class="pli-data-yes"></i> Enregsitrer
                                </button>
                                <button
                                    data-bs-dismiss="modal"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mt-5">
                                    <textarea
                                        ...
                                        cols="30"
                                        placeholder="Quelques notes sur le contenu du chapitre"
                                        rows="5"
                                    ></textarea>
                                </div>
                            </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mt-5">
                                    <textarea
                                        ...
                                        cols="30"
                                        placeholder="Quelques notes sur le contenu de l'exerice"
                                        rows="5"
                                    ></textarea>
                                </div>
                                <div class="mt-2">
                                    <label for=""
                                        >Fichier pdf de l'exercice</label
                                    >
                                    <input
                                        type="file"
                                        placeholder="Titre de l'exercice"
        ...
        <template v-slot:sidebar>
            <div>
                <div class="">
                    <h6 class="text-bg-primary fs-4 text-center">
                        ...
                        <div class="tl-content card">
                            <div class="card-body p-2">
                                ...
                                <span class="badge bg-danger"
                                    >{{ p.filiere.code }}{{ p.niveau_id }}</span
                                >
                                <figure class="m-0">
    ...
    methods: {
        ...
        async saveExercice() {
            ...
            if (this.pdf != null) {
                ...
                await this.api
                    .post("/api/prof/emploi/exercice", form, this.multipart)
                    .then((res) => {
                        this.post = res.data;
                        this.toaster.success(
                            "Creation de l'exercice effectuée avec succes !!!"
                        );
                        this.load();
                    })
                    .catch((err) => {
        ...
        async set_inprogress(id) {
            ...
            await axios
                .get("/api/prof/chapter/inprogress/" + id)
                .then((res) => {
                    console.log(res);
                    this.load();
                })
        ...
        async set_completed(id) {
            ...
            await axios
                .get("/api/prof/chapter/complete/" + id)
                .then((res) => {
                    console.log(res);
                    this.load();
                })
        ...
        async submit() {
            ...
            await axios
                .post("/api/prof/emploi/pointage", this.seance)
                .then((res) => {
        ...
        async submit_chapter() {
            ...
            await axios
                .post("/api/prof/emploi/chapter", this.chapter)
                .then((res) => {
                    console.log(res.data);
                    this.load();
                })
